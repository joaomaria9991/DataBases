		...
		BEGIN TRY
				...
				DECLARE @data_atual SMALLDATETIME = CAST(GETDATE() AS smalldatetime);
					...
					BEGIN TRANSACTION
						...
						VALUES (@id_user, 1 ,1, @email_pagamento, '2017-05-22 23:13:00');
						
						INSERT INTO TorrentTracker.Compra ([ID_Comprador],[ID_plano],[DataHoraCompra],[DataHoraTermino]) 
						VALUES (@id_user, @plano_id, '2017-05-22 23:13:00', '2017-05-22 23:13:00');
					COMMIT TRAN
...
/*  Testes:
TorrentTracker.ComprarPlano 'Bert', 'VIP 3', 'test@ua.pt'


INSERT INTO TorrentTracker.UtilizadorVip([ID_User],[ImunidadeHitRun],[FreeleechTotal],[EMailPagamento],[DataHoraPagamento]) 
						VALUES (2, 1 ,1, 'test@ua.pt', '2017-05-22 23:13:00');

INSERT INTO TorrentTracker.Compra ([ID_Comprador],[ID_plano],[DataHoraCompra],[DataHoraTermino]) 
						VALUES (2, 3, '2017-05-22 23:13:00', '2017-05-22 23:13:00');

DECLARE @role VARCHAR(30) = (SELECT TorrentTracker.UserRole_Function ('Joseph'));
				PRINT 'ID= ' + @role ;
SELECT * FROM TorrentTracker.Compra
SELECT * FROM TorrentTracker.UtilizadorVip

DELETE FROM TorrentTracker.UtilizadorVip WhERE ID_User=3
DELETE FROM TorrentTracker.Compra WhERE ID_Comprador=2
...
DROP TRIGGER TorrentTracker.Trigger_ContentTorrentGame_Adicionar;
GO
...
DROP TRIGGER TorrentTracker.Trigger_ContentTorrentProgram_Adicionar;
GO
...
DROP TRIGGER TorrentTracker.Trigger_CategoriasInfoAutoDownload_Adicionar;
GO
...
DROP TRIGGER TorrentTracker.Trigger_ContentTorrentSeries_Adicionar;
GO
...
DROP TRIGGER TorrentTracker.Trigger_ContentTorrentMoviess_Adicionar;
GO
