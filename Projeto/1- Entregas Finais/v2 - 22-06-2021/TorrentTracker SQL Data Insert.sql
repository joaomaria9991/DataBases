...
--  Colocar indices nos parametros de pesuisas 
-- transacacoes -> atualizar + que uma tabela.
...
-- 10 Comentarios
--INSERT INTO TorrentTracker.ContentTorrentsContemComentarios([ID_ContentTorrent],[ID_Comentario]) VALUES(2,12),(4,36),(3,36),(3,22),(1,28),(5,40),(4,9),(1,12),(4,40),(3,50),(2,26),(3,26),(5,44),(2,5),(5,7),(5,32),(2,11),(2,20),(2,37),(2,3),(2,39),(3,48),(5,10),(3,38),(4,33),(2,3),(1,39),(3,11),(4,50),(1,42),(5,12),(5,38),(1,9),(2,29),(1,47),(2,19),(5,49),(1,3),(1,5),(1,7),(4,15),(3,36),(3,40),(1,4),(3,8),(1,17),(2,19),(4,35),(5,39),(1,44);
--GO
...
---- Testar encriptação passwords na BD
--Declare @ola VarChar(500) = (SELECT UserPassword
--FROM TorrentTracker.Utilizador
--where ID_User=1);

--Declare @ola2 VarChar(500) = EncryptByPassPhrase('ThePassphrase', 'NSW52MMJ0WN')
--Print('OLAAA:   '+@ola);
--Print('OLAAA2:   '+@ola2);

--DECLARE @HashThis VARCHAR(500) = 'NSW52MMJ0WN';  
--SET @HashThis = CONVERT(NVARCHAR(32),'NSW52MMJ0WN');  
--SELECT HASHBYTES('SHA2_256', @HashThis);  

--Print('Hash 1: '+ @HashThis);

--DECLARE @HashThis2 NVARCHAR(32);  
--SET @HashThis2 = CONVERT(NVARCHAR(32),'NSW52MMJ0WN');  
--SELECT HASHBYTES('SHA2_256', @HashThis2);

--Print('Hash 2: '+ @HashThis2);
